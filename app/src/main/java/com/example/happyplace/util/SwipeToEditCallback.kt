...
abstract class SwipeToEditCallback(context: Context):
    ...
    private val intrinsichWidth = editIcon!!.intrinsicWidth
    ...
    override fun onChildDraw(
        ...
        val editIconLeft = itemView.left + editIconMargin - intrinsichWidth
        val editIconRight = itemView.left + editIconMargin
        val editIconBotom = editIconTop + intrinsicHeight

        //draw delete icon
        editIcon!!.setBounds(editIconLeft, editIconTop, editIconRight, editIconBotom)
        editIcon.draw(c)
        super.onChildDraw(c, recyclerView, viewHolder, dX, dY, actionState, isCurrentlyActive)

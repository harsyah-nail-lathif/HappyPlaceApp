...
import com.example.happyplace.util.GetAdressFromLatLang
...
class AddHappyPlaceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private val mLocationCallBack = object : LocationCallback(){
        override fun onLocationResult(locationResult: LocationResult?) {
            ...
            val addressTask = GetAdressFromLatLang(this@AddHappyPlaceActivity, mLatitude, mLongitude)
            addressTask.setAdressListener(object : GetAdressFromLatLang.AddressListener{
                override fun onAdressFound(address: String) {
